...
PHOTOS = [
    ...
    ("p-9232.jpg", "clips", "he got a mouse",
     "Jasper on the blue rug with a computer mouse held under one foreleg, looking away from the camera."),
    ...
    ("p-6322.jpg", "wave",  "Garnet & Jasper",
     "Garnet and Jasper both going for the same squeeze treat out of Ernie's hand."),
